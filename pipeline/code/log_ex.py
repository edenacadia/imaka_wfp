# found here: https://stackoverflow.com/questions/22643337/per-thread-logging-in-python#22645905
# Eden McEwen for the little edits
# July 12 2020
...
def start_thread_logging():
    ...
    name = thread_name.replace("ThreadPoolExecutor-", "")
    log_file ='{}ThreadLogging-{}.log'.format(out_dir, name)
...
def config_root_logger(dir_base=None):
    global out_dir
    if dir_base:
        out_dir = dir_base
    log_file = out_dir + 'ThreadLogging.log'
